    ...
    <main className="container mx-auto border-l border-r border-black/10 min-h-screen">
      ...
      <section className="py-11 px-11">
        <div className="grid grid-cols-4 gap-5">
          <div className="border bg-cyan-300 bg-opacity-40 rounded-[10px] h-[450px] flex items-center justify-center flex-col px-5">
            <svg
              width="148"
              height="148"
              viewBox="0 0 148 148"
            ...
            <div>
              <button className="px-[60px] py-[10px] rounde-[10px] bg-cyan-400 rounded-[6px] pt-[3px] mt-[20px] items-center flex">
                follow
              </button>
            </div>
          </div>
          <div className="border rounded-[10px] h-[450px] col-span-2 overflow-hidden">
            <Weather />
          </div>
          ...
          <div className="border bg-cyan-300 bg-opacity-40 rounded-[10px] h-[450px] overflow-hidden">
            <div  className=" flex items-center justify-center h-full flex flex-col space-y-[20px] ">
              ...
              <div className="flex space-x-[10px]">
                <p className="h-[40px] w-[40px] rounded-full bg-cyan-400 bg-opacity-50 flex items-center justify-center">
                  <Facebook color="#fff" />
                </p>
                <p className="h-[40px] w-[40px] rounded-full bg-cyan-400 bg-opacity-50 flex items-center justify-center">
                  <Dribbble color="#fff" />
              ...
              <div>
                <button className="px-[60px] py-[10px] rounde-[10px] bg-cyan-400 rounded-[6px] pt-[3px]">
                  follow
                </button>
              </div>
            </div>
